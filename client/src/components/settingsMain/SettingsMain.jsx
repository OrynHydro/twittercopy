...
import {SettingsRightbar} from './../index'
...
const SettingsMain = ({activePage, setActivePage}) => {
    ...
    return (  
            <div style={{display: 'flex'}} className={activePage === 'addition' ? 'test' : null}>
                <div className={activePage === 'addition' ? 'settingsMain specialMain' : 'settingsMain'} >
                    <h2 className="settingsTitle">Settings</h2>
                    <h1 className="settingsPostTitle">Privacy</h1>
                    {/* 1 block */}
                    <Link to='/settings/account/personalization'>
                        <div className={location.pathname === '/settings/account/personalization' ? 'settingsItem active' : 'settingsItem'}>
                    ...
                    <Link to='/settings/your_twitter_data'>
                        <div className={location.pathname === '/settings/your_twitter_data' ? 'settingsItem active' : 'settingsItem'}>
                    ...
                    <Link to='/settings/about'>
                        <div className={location.pathname === '/settings/about' ? 'settingsItem active' : 'settingsItem'}>
