		...
		<>
			...
			>
				<div
					className={
						postPage
							? 'homePostContainer postPageContainer'
							: 'homePostContainer'
					}
					style={{
								...
								<div className='replyNotificationBlock'>
									...
									>
										<Link to={`/${post?.user.userId}`}>
											<h2 className='homePostUsername'>
												{post?.user?.username}
											</h2>
										</Link>
										<Link to={`/${post?.user.userId}`}>
											<span className='homePostUserId'>
												{post?.user?.userId}
											</span>
										</Link>
			...
			{activeModal && (
				<Share
					...
					user={currentUser}
					activeShareModal={activeModal}
					setActiveShareModal={setActiveModal}
					originalPost={post}
				/>
			)}
		</>
