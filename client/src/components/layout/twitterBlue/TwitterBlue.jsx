...
const TwitterBlue = ({ active, setActive }) => {
	...
	return (
		<div className={active ? 'twitterBlue active' : 'twitterBlue'}>
			<div
				className={
					activeMore ? 'twitterBlueContainer active' : 'twitterBlueContainer'
				}
			>
				<div className='twitterBlueTop'>
					<img
						className='logoImg'
						src={PF + 'icon/common/checkmark.png'}
						alt=''
					/>
					<div
				...
				<div className='twitterBlueMid'>
					...
					<div className='twitterBlueSwitchBlock'>
						<div
							className={
								activeAnnually
									? 'twitterBlueSwitchItem'
									: 'twitterBlueSwitchItem disabled'
							}
							onClick={() => {
					...
					<div className='twitterBlueDesc'>
						...
						<ul className='twitterBlueDescList'>
							<li className='twitterBlueDescItem'>
						...
						<div
							className={
								activeMore ? 'learnMoreBlock active' : 'learnMoreBlock'
							}
						...
						>
							...
							<img
								src={
									activeMore
										? PF + 'icon/utility/chevronUp.svg'
										: PF + 'icon/utility/chevronDownGray.svg'
								}
								alt=''
							/>
						</div>
						...
						<div className={activeMore ? 'moreBlock active' : 'moreBlock'}>
							<div className='moreBlockItem'>
								<img
									src={PF + 'icon/common/feather.svg'}
									alt=''
									className='moreBlockIcon'
								/>
								<div className='moreBlockContent'>
									<h3 className='moreBlockTitle'>Longer Tweets</h3>
									<span className='moreBlockDesc'>
										Create Tweets, replies and Quotes up to 10,000 characters
										long.
									</span>
								</div>
							</div>
							...
							<div className='moreBlockItem'>
								<img
									src={PF + 'icon/common/userSmall.svg'}
									alt=''
									className='moreBlockIcon'
								/>
								<div className='moreBlockContent'>
									...
									<span className='moreBlockDesc'>
										Show your personal flair and set your profile picture to an
										NFT you own.
									</span>
								</div>
							</div>
				...
				<div
					className='twitterBlueBottom'
					style={{ borderBottomRightRadius: activeMore ? '0px' : '12px' }}
				>
					<div className='twitterBlueBottomContainer'>
						<button className='twitterBlueBottomBtn'>
							<span
								className='fullPrice'
								style={{ display: activeMonthly ? 'none' : 'inline' }}
							>
								$96.00
							</span>{' '}
							{activeAnnually ? '$84.00 / year' : '$8.00 / month'}
						</button>
						<p className='twitterBlueBottomDesc'>
							By subscribing, you agree to our{' '}
							<Link>Purchaser Terms of Service.</Link> Subscriptions auto-renew
							until canceled, as described in the Terms. Cancel anytime. A
							verified phone number is required to subscribe. If you've
							subscribed on another platform, manage your subscription through
							that platform.
						</p>
					</div>
				</div>
