...
const UnregisteredBlock = () => {
	...
	return (
		...
		<>
			...
			<RegisterForm
				activeForm={activeRegisterForm}
				setActiveForm={setActiveRegisterForm}
			/>
			<LoginForm
